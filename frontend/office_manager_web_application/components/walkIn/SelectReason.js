...
const list = [
    ...
    {
        id: "3",
        name: "Problems with Registration",
    },
    {
        id: "4",
        name: "Leave Of Absence/Institute Withdrawal ",
    },
    {
        id: "5",
        name: "Change Of Program – out",
    },
    {
        id: "6",
...
export default function SelectReason(props) {
    ...
    return (
        <View style={styles.container}>
            {!reason && <ProgressBar width={"75%"} progress={75} />}
            ...
            <View style={styles.advisorContainer}>
                <View style={styles.advisorHead}>
                    <Text style={styles.advisorTxt}>Select A Reason</Text>
                </View>
                <ScrollView>
                    {list.map(item => {
