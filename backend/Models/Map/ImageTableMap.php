...
class ImageTableMap extends TableMap
{
     ...
     */
    const COL_NAME = 'image.name';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'image.data';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Data', ),
        self::TYPE_CAMELNAME     => array('name', 'data', ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_NAME, ImageTableMap::COL_DATA, ),
        self::TYPE_FIELDNAME     => array('name', 'data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Data' => 1, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'data' => 1, ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_NAME => 0, ImageTableMap::COL_DATA => 1, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'data' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'image.name' => 'NAME',
        'ImageTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'Data' => 'DATA',
        'Image.Data' => 'DATA',
        'data' => 'DATA',
        'image.data' => 'DATA',
        'ImageTableMap::COL_DATA' => 'DATA',
        'COL_DATA' => 'DATA',
    ];
    ...
    public function initialize()
    {
        ...
        $this->addColumn('data', 'Data', 'VARBINARY', true, null, null);
    } // initialize()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ImageTableMap::COL_NAME);
            $criteria->addSelectColumn(ImageTableMap::COL_DATA);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(ImageTableMap::COL_NAME);
            $criteria->removeSelectColumn(ImageTableMap::COL_DATA);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ImageTableMap::COL_NAME, (array) $values, Criteria::IN);
        }
