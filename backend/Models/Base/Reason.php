...
/**
 * Base class that represents a row from the 'reason' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Reason implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ReasonTableMap';
    ...
    /**
     * The value for the is_grad field.
     *
     * @var        boolean
     */
    protected $is_grad;
    ...
    /**
     * Initializes internal state of Base\Reason object.
     */
    ...
    /**
     * Compares this with another <code>Reason</code> instance.  If
     ...
     * @return boolean
     */
    public function isGrad()
    {
        return $this->getIsGrad();
    }
     ...
     * @return $this|\Reason The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ReasonTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ReasonTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Sets the value of the [is_grad] column.
    ...
    public function setIsGrad($v)
    {
        ...
        if ($this->is_grad !== $v) {
            $this->is_grad = $v;
            $this->modifiedColumns[ReasonTableMap::COL_IS_GRAD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ReasonTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReasonTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReasonTableMap::translateFieldName('IsGrad', TableMap::TYPE_PHPNAME, $indexType)];
            $this->is_grad = (null !== $col) ? (boolean) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ReasonTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Reason'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildReasonQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Reason::setDeleted()
     * @see Reason::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildReasonQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ReasonTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReasonTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ReasonTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ReasonTableMap::COL_IS_GRAD)) {
            $modifiedColumns[':p' . $index++]  = 'is_grad';
        }

        $sql = sprintf(
            'INSERT INTO reason (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'is_grad':
                        $stmt->bindValue($identifier, (int) $this->is_grad, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = ReasonTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Reason'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Reason'][$this->hashCode()] = true;
        $keys = ReasonTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getIsGrad(),
        );
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Reason The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReasonTableMap::COL_ID)) {
            $criteria->add(ReasonTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ReasonTableMap::COL_NAME)) {
            $criteria->add(ReasonTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ReasonTableMap::COL_IS_GRAD)) {
            $criteria->add(ReasonTableMap::COL_IS_GRAD, $this->is_grad);
        }
    ...
    {
        $criteria = ChildReasonQuery::create();
        $criteria->add(ReasonTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Reason (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIsGrad($this->getIsGrad());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Reason Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildReason is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildReason The current object (for fluent API support)
     */
     ...
     * Otherwise if this Reason is new, it will return
     * an empty collection; or if this Reason has previously
     * been saved, it will retrieve related Visits from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Reason.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ReasonTableMap::DEFAULT_STRING_FORMAT);
    }
