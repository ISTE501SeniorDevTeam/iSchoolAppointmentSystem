...
abstract class Image implements ActiveRecordInterface
{
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ImageTableMap::COL_NAME] = true;
        }
    ...
    public function setData($v)
    {
        ...
        $this->modifiedColumns[ImageTableMap::COL_DATA] = true;
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImageTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImageTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            if (null !== $col) {
                $this->data = fopen('php://memory', 'r+');
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ImageTableMap::COL_DATA)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ImageTableMap::COL_NAME)) {
            $criteria->add(ImageTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ImageTableMap::COL_DATA)) {
            $criteria->add(ImageTableMap::COL_DATA, $this->data);
        }
