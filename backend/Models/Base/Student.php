...
abstract class Student implements ActiveRecordInterface
{
    ...
    /**
     * The value for the major_id field.
     *
     * @var        int|null
     */
    protected $major_id;
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[StudentTableMap::COL_UID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[StudentTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [major_id] column.
     *
     * @param int|null $v New value
     * @return $this|\Student The current object (for fluent API support)
     */
    public function setMajorId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->major_id !== $v) {
            $this->major_id = $v;
            $this->modifiedColumns[StudentTableMap::COL_MAJOR_ID] = true;
        }

        if ($this->aMajor !== null && $this->aMajor->getId() !== $v) {
            $this->aMajor = null;
        }
    ...
    public function setAdvisorId($v)
    {
        ...
        if ($this->advisor_id !== $v) {
            $this->advisor_id = $v;
            $this->modifiedColumns[StudentTableMap::COL_ADVISOR_ID] = true;
        }
    ...
    /**
     * Set the value of [ritid] column.
     *
     * @param string|null $v New value
     * @return $this|\Student The current object (for fluent API support)
     */
    public function setRitid($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->ritid !== $v) {
            $this->ritid = $v;
            $this->modifiedColumns[StudentTableMap::COL_RITID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StudentTableMap::translateFieldName('Uid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StudentTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StudentTableMap::translateFieldName('MajorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->major_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StudentTableMap::translateFieldName('AdvisorId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->advisor_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StudentTableMap::translateFieldName('Ritid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ritid = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    {
        if ($this->aMajor !== null && $this->major_id !== $this->aMajor->getId()) {
            $this->aMajor = null;
        }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMajor !== null) {
                if ($this->aMajor->isModified() || $this->aMajor->isNew()) {
                    $affectedRows += $this->aMajor->save($con);
                }
                $this->setMajor($this->aMajor);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_UID)) {
            $modifiedColumns[':p' . $index++]  = 'uid';
        }
        if ($this->isColumnModified(StudentTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(StudentTableMap::COL_MAJOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'major_id';
        }
        if ($this->isColumnModified(StudentTableMap::COL_ADVISOR_ID)) {
            $modifiedColumns[':p' . $index++]  = 'advisor_id';
        }
        if ($this->isColumnModified(StudentTableMap::COL_RITID)) {
            $modifiedColumns[':p' . $index++]  = 'ritid';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'major_id':
                        $stmt->bindValue($identifier, $this->major_id, PDO::PARAM_INT);
                        break;
                    case 'advisor_id':
                        $stmt->bindValue($identifier, $this->advisor_id, PDO::PARAM_STR);
                        break;
                    case 'ritid':
                        $stmt->bindValue($identifier, $this->ritid, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getUid(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getMajorId(),
            $keys[3] => $this->getAdvisorId(),
            $keys[4] => $this->getRitid(),
        );
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aMajor) {
                ...
                $result[$key] = $this->aMajor->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setMajorId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setAdvisorId($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setRitid($arr[$keys[4]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StudentTableMap::COL_UID)) {
            $criteria->add(StudentTableMap::COL_UID, $this->uid);
        }
        if ($this->isColumnModified(StudentTableMap::COL_NAME)) {
            $criteria->add(StudentTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(StudentTableMap::COL_MAJOR_ID)) {
            $criteria->add(StudentTableMap::COL_MAJOR_ID, $this->major_id);
        }
        if ($this->isColumnModified(StudentTableMap::COL_ADVISOR_ID)) {
            $criteria->add(StudentTableMap::COL_ADVISOR_ID, $this->advisor_id);
        }
        if ($this->isColumnModified(StudentTableMap::COL_RITID)) {
            $criteria->add(StudentTableMap::COL_RITID, $this->ritid);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMajorId($this->getMajorId());
        $copyObj->setAdvisorId($this->getAdvisorId());
        $copyObj->setRitid($this->getRitid());
    ...
    /**
     * Declares an association between this object and a ChildMajor object.
     *
     * @param  ChildMajor|null $v
     * @return $this|\Student The current object (for fluent API support)
     * @throws PropelException
     */
    public function setMajor(ChildMajor $v = null)
    {
        if ($v === null) {
            $this->setMajorId(NULL);
        } else {
            $this->setMajorId($v->getId());
        }

        $this->aMajor = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildMajor object, it will not be re-added.
        if ($v !== null) {
            $v->addStudent($this);
        }
    ...
    /**
     * Get the associated ChildMajor object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildMajor|null The associated ChildMajor object.
     * @throws PropelException
     */
    public function getMajor(ConnectionInterface $con = null)
    {
        if ($this->aMajor === null && ($this->major_id != 0)) {
            $this->aMajor = ChildMajorQuery::create()->findPk($this->major_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMajor->addStudents($this);
             */
        }
    ...
    public function getEmployee(ConnectionInterface $con = null)
    {
        if ($this->aEmployee === null && (($this->advisor_id !== "" && $this->advisor_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmployee->addStudents($this);
             */
        }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildVisit}> List of ChildVisit objects
     */
    public function getVisitsJoinEmployee(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildVisitQuery::create(null, $criteria);
    ...
    {
        if (null !== $this->aMajor) {
            $this->aMajor->removeStudent($this);
        }
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeStudent($this);
        }
        $this->uid = null;
        $this->name = null;
        $this->major_id = null;
