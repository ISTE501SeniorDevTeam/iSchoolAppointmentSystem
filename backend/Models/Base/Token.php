...
abstract class Token implements ActiveRecordInterface
{
    ...
    public function setEmployeeid($v)
    {
        ...
        if ($this->employeeid !== $v) {
            $this->employeeid = $v;
            $this->modifiedColumns[TokenTableMap::COL_EMPLOYEEID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TokenTableMap::translateFieldName('Employeeid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->employeeid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TokenTableMap::translateFieldName('Token', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TokenTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aEmployee !== null && $this->employeeid !== $this->aEmployee->getUid()) {
            $this->aEmployee = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_EMPLOYEEID)) {
            $modifiedColumns[':p' . $index++]  = 'employeeId';
        }
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'employeeId':
                        $stmt->bindValue($identifier, $this->employeeid, PDO::PARAM_STR);
                        break;
                    case 'token':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TokenTableMap::COL_EMPLOYEEID)) {
            $criteria->add(TokenTableMap::COL_EMPLOYEEID, $this->employeeid);
        }
        if ($this->isColumnModified(TokenTableMap::COL_TOKEN)) {
    ...
    public function hashCode()
    {
        ...
        //relation token_fk_49426d to table employee
    ...
    {
        $this->setEmployeeid($keys[0]);
        $this->setToken($keys[1]);
    }
    ...
    {
        return (null === $this->getEmployeeid()) && (null === $this->getToken());
    }
    ...
    {
        if ($this->aEmployee === null && (($this->employeeid !== "" && $this->employeeid !== null))) {
            $this->aEmployee = ChildEmployeeQuery::create()->findPk($this->employeeid, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmployee->addTokens($this);
             */
        }
    ...
    {
        if (null !== $this->aEmployee) {
            $this->aEmployee->removeToken($this);
        }
